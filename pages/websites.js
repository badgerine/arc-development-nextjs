      ...
      >
        ...
        <Hidden mdDown>
          <Grid item className={classes.arrowContainer} style={{ marginRight: '1em', marginLeft: '-3.5em' }}>
            ...
            >
              <img src='/assets/backArrow.svg' alt='Back to iOS/Android Apps Development Page' />
            </IconButton>
          </Grid>
        </Hidden>
        {/*website dev intro */}
        ...
        <Hidden mdDown>
          <Grid item className={classes.arrowContainer}>
            ...
            >
              <img src='/assets/forwardArrow.svg' alt='Return to Services Page' />
            </IconButton>
          </Grid>
        </Hidden>
      </Grid>
      ...
      >
        <Grid item >
          <Grid container direction='column'>
            ...
            <Grid item>
              <img className={classes.icon} alt='graph with magnifying glass' src='/assets/analytics.svg' style={{ marginLeft: '-2.75em' }} />
            </Grid>
          </Grid>
        </Grid>
      ...
      >
        <Grid item>
          <Grid container direction='column'>
            ...
            <Grid item>
              <img className={classes.icon} alt='world globe outline' src='/assets/ecommerce.svg' />
            </Grid>
          </Grid>
        </Grid>
      ...
      >
        <Grid item >
          <Grid container direction='column'>
            ...
            <Grid item>
              <img className={classes.icon} alt='megaphone' src='/assets/outreach.svg' />
            </Grid>
          </Grid>
        </Grid>
        <Grid item className={classes.paragraphContainer} >
      ...
      >
        <Grid item>
          <Grid container direction='column' >
            ...
            <Grid item>
              <img className={classes.icon} alt='pc monitor on podium' src='/assets/seo.svg' />
            </Grid>
          </Grid>
        </Grid>
        <Grid item className={classes.paragraphContainer} >
