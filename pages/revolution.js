...
const Revolution = (props) => {
  ...
  return (
    <Grid container direction='column'>
      ...
      <Grid item container direction={matchesMD ? 'column' : 'row'} alignItems='center' justify='center'
      ...
      <Grid item container direction={matchesMD ? 'column' : 'row'} alignItems='center' justify='center'
        style={{ marginTop: '5em' }} className={classes.rowContainer}
      >
      ...
      >
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              That’s just a fancy term for a mockup, which doesn’t include colors, images,
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/consultationIcon.svg' alt='handshake' width='100%' style={{ maxWidth: '40em' }} />
        </Grid>
      </Grid>
      {/*----layout container - mockup----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
        className={classes.rowContainer}
      ...
      >
        <Grid item container direction='column'
          alignItems={matchesMD ? 'center' : undefined} lg>
          <Grid item >
            <Typography variant='h4' style={{ color: '#000', marginTop: '5em' }} align={matchesMD ? 'center' : undefined}>
              Mockup
            </Typography>
          </Grid>
          <Grid item style={{ maxWidth: '20em' }} >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/mockupIcon.svg' alt='pc screen' width='100%' style={{ maxWidth: matchesMD ? '40em' : 1000 }} />
        </Grid>
      </Grid>
      ...
      >
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              any ideas you may have come up with before any heavy lifting has been done.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              We give you an interactive demonstration of the mockups,
              thoroughly explaining the thought process that went into each screen and every anticipated feature.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/reviewIcon.svg' alt='magnifying glass' width='100%' style={{ maxWidth: '35em' }} />
        </Grid>
      </Grid>
      ...
      >
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/designIcon.svg' alt='paint brush' width='100%' style={{ maxWidth: matchesMD ? '50em' : '45em' }} />
        </Grid>
      </Grid>
      {/*----layout container - review----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
        className={classes.rowContainer}
        style={{ backgroundColor: '#39BF4A', height: '90em', }}
        align={matchesMD ? 'center' : undefined}
      >
        <Grid item container direction='column'
          alignItems={matchesMD ? 'center' : undefined} lg>
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              Again this gives you an opportunity to tweak things and make sure we get everything right the first time.
            </Typography>
          </Grid>
        </Grid>
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/reviewIcon.svg' alt='magnifying glass'
            width='100%'
            style={{ maxWidth: '35em' }}
          />
        </Grid>
        ...
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              We start by scaffolding out the project on a high level, prioritizing some areas over others.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              Once all the services are in place we can then create the front end, user side of things.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              Finishing the application doesn’t mean we’re done though,
              because we use extensive testing to guarantee compatibility with all intended devices.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              Only after our rigorous examinations will we accept a product as finished,
              then pushing it through the production pipeline.
              This produces an optimized, compressed, consumer version of the code and assets ready for deployment.
            </Typography>
          </Grid>
        </Grid>
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/buildIcon.svg' alt='construction crane beside building'
            height='100%'
            style={{ maxHeight: matchesMD ? '15em' : '30em' }} />
        </Grid>

      </Grid>
      {/*----layout container - launch----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
        className={classes.rowContainer}
        ...
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              We’ll give our final demonstration to show off your shiny new software in the wild
              so you know exactly how it will look to your users.
            </Typography>
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              When you say the word, we press the button and launch your project out to the public.
              We’re there to ensure everything goes to plan so you can start reaping the rewards of your technological investment immediately.
            </Typography>
          </Grid>
        </Grid>
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/launchIcon.svg' alt='rocket'
            height='100%'
            style={{ maxHeight: matchesMD ? '40em' : '60em' }} />
        </Grid>
      </Grid>
      {/*----layout container - maintain----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
        className={classes.rowContainer}
      ...
      >
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              taking advantage of the best features and practices available.
        ...
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/maintainIcon.svg' alt='spanner on nut'
            height='100%'
            style={{ maxHeight: matchesMD ? '40em' : '60em' }}
          />
        </Grid>
      </Grid>
      {/*----layout container - iterate----*/}
      <Grid item container direction={matchesMD ? 'column' : 'row'}
        className={classes.rowContainer}
        ...
        <Grid item container direction='column'
          ...
          <Grid item style={{ maxWidth: '20em' }}>
            ...
            <Typography variant='body1' paragraph align={matchesMD ? 'center' : undefined} style={{ color: '#fff' }}>
              ...
              allowing you to quickly implement changes instead of waiting months for a single update.
            </Typography>
          </Grid>
        </Grid>
        <Grid item style={{ alignSelf: 'center' }} lg>
          <img src='/assets/iterateIcon.svg' alt='falling dominos'
            width='100%'
            style={{ maxWidth: matchesMD ? '40em' : 1000 }}
          />
        </Grid>
      </Grid>
      <Grid>{/*----Call To Action----*/}
